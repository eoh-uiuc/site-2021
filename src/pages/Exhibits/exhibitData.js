const exhibitData = [
    ...
    exhibits: [
      {
        ...
        description:
          "Learn about nuclear science with the UIUC Women in Nuclear chapter! We talk about radiation, nuclear power plants, and plasmas.",
      ...
      },
      {
        ...
        video: "https://www.youtube.com/watch?v=fLM5F0u0D9E",
        description: "Interactive projects exploring everything nuclear!",
  ...
  },
  {
    ...
    link: "/exhibits/mechanical-engineering-laboratory",
    latitude: 40.1121,
    longitude: -88.2263,
    description:
      "In Spring 2019, construction began on a three-story addition to the south face of Talbot Laboratory.",
    tags: "",
    exhibits: [
      {
        name: "Exhibit Name",
        ...
        links: [
          {
            name: "RSO Site",
            address: "http://www.ec.illinois.edu",
          },
          {
            name: "Read More",
  ...
  },
  {
    ...
    link: "/exhibits/everitt-laboratory",
    latitude: 40.1111,
    longitude: -88.22841,
    description:
      "In Spring 2019, construction began on a three-story addition to the south face of Talbot Laboratory.",
    exhibits: [
      {
        ...
        video: "https://www.youtube.com/watch?v=fLM5F0u0D9E",
        description: "2-3 sentences describing the exhibit video.",
        tags: ["mechanical", "easy", "quick", "natural"],
        links: [
          {
            name: "RSO Site",
            address: "http://www.ec.illinois.edu",
      ...
      },
      {
        ...
        video: "https://www.youtube.com/watch?v=fLM5F0u0D9E",
        description: "2-3 sentences describing the exhibit video.",
        tags: ["mechanical", "difficult", "long"],
        links: [
          {
            name: "RSO Site",
            address: "http://www.ec.illinois.edu",
  ...
  },
  {
    ...
    link: "/exhibits/talbot-laboratory",
    latitude: 40.11215,
    longitude: -88.22844,
    description:
      "In Spring 2019, construction began on a three-story addition to the south face of Talbot Laboratory.",
    exhibits: [
      {
        name: "Exhibit Name Name Name Name Name",
        rso: "Engineering Council",
        video: "https://www.youtube.com/watch?v=fLM5F0u0D9E",
        description: "2-3 sentences describing the exhibit video.",
        links: [
  ...
  },
  {
    ...
    link: "/exhibits/materials-science",
    latitude: 40.1111,
    longitude: -88.2263,
    description:
      "In Spring 2019, construction began on a three-story addition to the south face of Talbot Laboratory.",
